...
import { Settings as SettingsIcon, Save, Link as LinkIcon, Clock, Eye, EyeOff } from 'lucide-react';
...
export default function Settings() {
  ...
  const updateModuleVisibility = (module: keyof Settings['modulesVisibility'], value: boolean) => {
    if (!settings) return;
      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {Object.entries(settings.modulesVisibility).map(([module, isVisible]) => (
              <div key={module} className="flex items-center justify-between py-2">
                ...
                <Switch
                  checked={isVisible}
                  onCheckedChange={(value) => updateModuleVisibility(module as keyof Settings['modulesVisibility'], value)}
                />
              </div>
            ))}
          </CardContent>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="sliderInterval">Auto-scroll Interval (milliseconds)</Label>
              <Input
                id="sliderInterval"
                type="number"
                value={settings.sliderAutoScrollInterval}
                onChange={(e) => updateSliderInterval(parseInt(e.target.value) || 5000)}
                min="1000"
                step="1000"
                placeholder="5000"
              />
              <p className="text-xs text-gray-500">
                Time between automatic slide transitions. Minimum: 1000ms (1 second)
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-gray-500">
                Leave empty to disable the statistics section. This link will open in the app's browser or WebView.
              </p>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span>
                    {Object.values(settings.modulesVisibility).filter(Boolean).length}/
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className={settings.statisticsLink ? 'text-green-600' : 'text-gray-400'}>
